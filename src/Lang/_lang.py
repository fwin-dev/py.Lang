...
def abstractmethod(method):
	""" This implementation of @abstractmethod only to be used with @abc.classmethod to make an
		abstract class method because of bug: http://bugs.python.org/issue5867 """
...
def getArgs(useKwargFormat, numFramesAgo=1, excludeList=[]):
	""" useKwargFormat:	If true, returns a dict of parameters and values.
...
# 
# @timeIt
# def funcThatDoesSomething(args):
# 	...
# 
